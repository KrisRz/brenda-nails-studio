        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div
              ...
              className="group relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 hover:bg-white/80 transition-all duration-500 hover:scale-105 hover:shadow-2xl interactive-card hover-glow hover-lift text-center md:text-left"
            >
              {/* Icon */}
              <div
                className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${value.gradient} flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform duration-300 mx-auto md:mx-0`}
              >
                {value.icon}
              </div>

              {/* Content */}
              <h3 className="text-xl  font-bold text-gray-900 mb-4 luxury-heading group-hover:text-rose-600 transition-colors duration-300 text-reveal">
